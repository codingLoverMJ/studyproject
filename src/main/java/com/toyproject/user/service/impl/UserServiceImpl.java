...
public class UserServiceImpl implements UserService{
	...
	public String getAccessToken(String authorize_code) {
		...
		try {
			...
			sb.append("&client_id=9f892ab9db710f402ce743b042a7123f");
			sb.append("&redirect_uri=http://localhost:8080/user/loginKakao");
	...
	public HashMap<String, Object> getUserInfo(String access_Token) {
		...
		try {
			...
			System.out.println(" nickname : " + properties.getAsJsonObject().get("nickname").getAsString());
